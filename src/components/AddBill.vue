                    ...
                    <b-row>
                        <form @submit.prevent='' class='wide'>
                            ...
                            <div class='form-group'>
                                ...
                                <ul>
                                    <li v-for='person in bill.people'>
                                        {{ getFullName(person) }}
                                    </li>
                                </ul>
...
<script>
    ...
    export default {
        ...
        watch: {
            ...
            bill: {
                deep: true,
                handler: function(newBill, oldBill) {
                    this.addPersonState.people.removeElement(oldBill.buyer, (person) => person.email);
                    this.addPersonState.people.push(newBill.buyer)
                }
            }
        },
        mounted() {
            ...
            this.addPersonState.allPeople = this.allPeople;
